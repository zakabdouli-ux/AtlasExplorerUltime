...
desc:"Destination entre plages et culture."
}
};
...
maroc.on("click", function(){ showCountry("Maroc"); });
algerie.on("click", function(){ showCountry("Algérie"); });
tunisie.on("click", function(){ showCountry("Tunisie"); });
